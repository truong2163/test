...
namespace Nhom11_Quanlybangiay.Khachhang
{
    public partial class frmKhachHangVoiNQL : Form
    {
        ...
        private void button1_Click(object sender, EventArgs e)
        {
            ...
            {
                MessageBox.Show("Bạn chưa chọn khách hàng nào để xem chi tiết!!!");
            }    
            else
            {
                //XEM NHỮNG HÓA ĐƠN BÁN CỦA MỘT KHÁCH HÀNG
                frmHoaDonBanHangCuaMotKhachHang f = new frmHoaDonBanHangCuaMotKhachHang(txtsdt.Text);
                f.Show();
            }    
        }
